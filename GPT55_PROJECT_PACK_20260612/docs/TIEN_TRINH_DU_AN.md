...
- [x] Tai khoan demo mac dinh tren app: `owner / <demo_password_removed>`
...
| Role | SĐT | Mật khẩu |
|------|------|----------|
| Admin | 0123456789 | <demo_password_removed> |
...
- [x] Tai khoan mau:
  ```text
  admin  / <demo_password_removed>  -> system_admin
  owner  / <demo_password_removed>  -> owner
  member / <demo_password_removed> -> member
  ```
- [x] Endpoint da co:
  ```text
  POST /api/auth/login
...
- [x] Tai khoan mau: Admin `0123456789` / `<demo_password_removed>`, User `0987654321` / `user123`
