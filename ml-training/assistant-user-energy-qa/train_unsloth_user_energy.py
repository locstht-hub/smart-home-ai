...
DEFAULT_SYSTEM_PROMPT = (
    "Ban la User Energy Assistant cua app Smart Home AI. "
    "Hay tra loi ngan gon, de hieu, khong bia so lieu va tap trung vao dien nang, quota, forecast, canh bao va cach dung app."
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fine-tune Smart Home AI User Energy Assistant with Unsloth.")
    ...
    parser.add_argument("--output_dir", default="assistant-user-energy-lora")
    ...
    metadata = {
        ...
        "output_dir": args.output_dir,
        "task": "smart_home_ai_user_energy_assistant",
        "excluded_scope": "project defense, GitHub, scientific paper, and detailed technical implementation",
    ...
    Path(args.output_dir, "user_energy_metadata.json").write_text(
